<template>
    <div>
        <div id="v-carousel" type="x/template">
            <div class="card-carousel-wrapper">
                ...
                <div class="card-carousel--overflow-container">
                    ...
                    <div class="card-carousel--card" v-on:click="carouselCardClick(current.movie_id)" v-for="(current, index) in currents" :key="index">
        ...
        <router-link class="main-list-more" :to="{name: 'movie_list', params: {status : 'current'}}">현재 상영작 목록</router-link>
    </div>
    
</template>

$emit('main-card-click', current.movie_id)
...
export default {
    ...
    methods: {
        ...
        carouselCardClick(index){
            this.$emit('main-card-click', index-1);
            document.getElementById('v-carousel').style['margin-top'] = '0rem';
        }
    }
}
